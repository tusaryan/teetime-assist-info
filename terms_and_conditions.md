...
Please read these Terms & Conditions (referred to as the “Terms”) carefully before installing or using the mobile application **TeeTime Assist - Control Hub** (referred to as the “Application” or “Service”).

By installing and using the Application, you agree to be bound by these Terms. If you do not agree with these Terms, please do not install or use the Application.

---

## ⚖️ 1. Use of the Application

*   **Hobbyist Utility**: TeeTime Assist is provided as a free, hobbyist system-shortcut utility designed to help users with physical button wear-and-tear or motor impairments. 
*   **License**: We grant you a limited, non-exclusive, non-transferable, and revocable license to install and use the Application on compatible Android devices for your personal, non-commercial use.
*   **Eligibility**: The Application is intended for users who are at least **18 years of age**. If you are under 18, you represent that you have parental consent to use the Application.
...
*   The Application requests absolutely NO network permissions and does not transmit any of your local settings, configurations, or input states off your device.
...
## 🏛️ 5. Governing Law and Jurisdiction

*   **Governing Law**: These Terms and any dispute arising out of or in connection with them shall be governed by and construed in accordance with the laws of India.
*   **Exclusive Jurisdiction**: Any legal action, claim, or dispute arising out of these Terms or the use of TeeTime Assist shall fall under the exclusive jurisdiction of the courts of the **Ramgarh district, Jharkhand, India**.
